...
pub const WATER_POS: Vec2 = Vec2::new(365.0, -250.0);
pub const GRAVITY: f32 = 6000.0;
pub const WATER_DRAG_Y: f32 = 4000.0;
pub const WATER_DRAG_X: f32 = 100.0;
pub const LINE_START_POS: Vec2 = Vec2::new(-290.0, 638.0);
pub const CAST_TARGET_POS: Vec2 = Vec2::new(300.0, 0.0);
pub const BEAR_POS: Vec2 = Vec2::new(-520.0, 540.0);
pub const FISH_STACK_HEIGHT: f32 = 15.0;
pub const STACK_POS: Vec3 = Vec3::new(-1100.0, 300.0, -1.0);
